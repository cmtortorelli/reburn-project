...
ggsave(datadir('figures/weather.png'), height = 5, width = 6.2)
```
...
ggsave(datadir('figures/windspeed.png'), height = 5, width = 6)
```
...
ggsave(datadir('figures/cbi.png'), height = 5, width = 7)
```
...
ggsave(datadir('figures/climate.png'), height = 5, width = 6.1)
```
