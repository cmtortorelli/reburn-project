...
gm = function(df){
  ...
  gamfit = gam(cbi_reburn ~ count_burn + #not logit tranformed response
                  s(AET, k = 5, bs = "cs") +
                  ...
                  s(time_betwe, by = AET, k = 5, bs = "cs") +
                  s(time_betwe, by = PRISM_ppt_, k = 5, bs = "cs") +
                  s(time_betwe, by = PRISM_tmea, k = 5, bs = "cs") +
                  s(time_betwe, by = vpd_02_21, k = 5, bs = "cs") +
                  s(time_betwe, by = vs_02_21, k = 5, bs = "cs") +
                  s(time_betwe, by = erc_02_21, k = 5, bs = "cs"),
                data = df,
             select = T) 
...
fit_ca = summary(gm(data_lowmod_ca))
fit_nm = summary(gm(data_lowmod_nm))
fit_sw = summary(gm(data_lowmod_sw))
fit_wm = summary(gm(data_lowmod_wm))
