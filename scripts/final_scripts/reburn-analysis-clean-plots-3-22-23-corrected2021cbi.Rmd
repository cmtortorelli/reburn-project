...
# ggsave(datadir("figures/ecoregion_overview2.svg"), width = 11, height = 6)
```
...
pca1 = plot_preds(ca_preds)
psw1 = plot_preds(sw_preds)
pnm1 = plot_preds(nm_preds)
pwm1 = plot_preds(wm_preds)

grid.arrange(pca1, psw1, pnm1, pwm1, nrow= 2, ncol=2)# 
...
ggsave(datadir('figures/weather3.png'), height = 5, width = 6.2)
```
...
ggsave(datadir('figures/cbi3.png'), height = 5, width = 7)
```
