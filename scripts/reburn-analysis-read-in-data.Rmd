...
preds_2scale = c("heat_load", "PRISM_tmea", "PRISM_ppt_", "TPI_1024", "fm100_02_2", "th_02_21", "vpd_02_21", "erc_02_21", "PRISM_vpdm", "AET", "fm1000_02_", "ndvi", "shrub_rebrn", "tree_reburn", "afg_rebrn", "pfg_rebrn")
...
fit3_ca = gm(data_lowmod_ca, k = 3)
fit3_nm = gm(data_lowmod_nm, k = 3)
fit3_sw = gm(data_lowmod_sw, k = 3)
fit3_wm = gm(data_lowmod_wm, k = 3)
...
predictor_plot_func = function(df_preds, df_raw, group_var){
  p = ggplot(data = df_preds, aes(x = time_betwe*10, y = cbi_reburn, color = group_var)) +
         geom_line(size = 1.05)+
  ...
  p2 = p + geom_rug(data = df_raw, aes(x = time_betwe*10, y = cbi_reburn), 
