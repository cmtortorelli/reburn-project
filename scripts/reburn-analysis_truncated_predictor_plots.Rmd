...
#write thinned data
# write.csv(data_thin, datadir("prelim-outputs/points/thinned_data_2-6-23.csv"))
```
...
ggplot(data = data_thin, aes(color = ecoregion, x = PRISM_tmea, y = PRISM_ppt_)) +
  ...
  scale_color_manual(values = c("#264653","#2A9D8F","#dbd053","#6a0136"))

#time between
ggplot(data = data_thin, aes(fill = ecoregion, x = time_betwe*10)) +
  geom_histogram(bins = 20)+
  theme_bw(13)+
  xlab("time between initial fire and reburn") +
  scale_fill_manual(values = c("#264653","#2A9D8F","#dbd053","#6a0136"))+
  facet_wrap(~ ecoregion)

#initial cbi
ggplot(data = data_thin, aes(fill = ecoregion, x = cbi_initial)) +
  geom_histogram()+
  theme_bw(13)+
  xlab("Initial CBI") +
  scale_fill_manual(values = c("#264653","#2A9D8F","#dbd053","#6a0136"))+
...
#reburn cbi
ggplot(data = data_thin, aes(fill = ecoregion, x = cbi_reburn)) +
  geom_histogram()+
  theme_bw(13)+
  xlab("Initial CBI") +
  scale_fill_manual(values = c("#264653","#2A9D8F","#dbd053","#6a0136"))+
...
anova(fit3_wm, fit4_wm, test = "Chisq") #sig, increases % dev explained by 4, from 22.7 to 24.3
```
