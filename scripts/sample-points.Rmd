...
#initial year tree cover - NOT COMPLETE! 2020 is missing and need to pull in the tree_initial data for 1986-1999
# treeli = tree %>% 
...
st_write(points_cleaned_facts_perims, datadir("prelim-outputs/points/points_cleaned_facts_perims-1-12-23.gpkg"))
...
st_write(points_fs_include, datadir("prelim-outputs/points/points_for_analysis_1-12-23.gpkg"))
