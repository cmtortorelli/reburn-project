...
write_csv(points_crit, datadir("prelim-outputs/points/points_for_analysis_11-30-22.csv"))  

points_crit = st_read(datadir("prelim-outputs/points/points_for_analysis_11-30-22.gpkg"))  
```
