...
r = rast(mtbs_yr, resolution = 0.000001, crs = 'epsg:4269') #resolution is super coarse! #not filling in YEAR values?

#crs(r) == crs(mtbs_perims)

mtbs_ca = extract(r, ca)
#---------------not sure why this isn't working.. Error- raster has no value - should have same projection..


#When two fires overlap, keep the year of the most recent and second most recent
mostrecent_fire = rasterize(mtbs_perims, r, field= "YEAR", fun=max)
...
secondrecent_fire = rasterize(mtbs_perims,r, field="YEAR", fun=second_highest_func)
