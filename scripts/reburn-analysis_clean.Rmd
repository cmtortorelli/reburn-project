...
fit3_ca = gm_prism(thin_ca, k = 6)
fit3_nm = gm_prism(thin_nm, k = 6)
fit3_sw = gm_prism(thin_sw, k = 6)
fit3_wm = gm_prism(thin_wm, k = 6)
...
library(ggridges)
data_thin_bps %>% 
  ggplot(aes(x = cbi_initial, y = CT_lumped_codes2, group = CT_lumped_codes2, fill = CT_lumped_codes2))+
  geom_density_ridges()+
  facet_grid(cols= vars(ecoregion), scales = "free")+
