...
-this isn't working properly, trying tiling the raster first. 
...
library(meteo)
elevNA = raster(datadir("/raw-data/Landfire/LC20_Elev_220_crop_NA.tif"))
...
```{r}
r = raster(datadir("/raw-data/Landfire/DEM_tiles/DEM_tile_1.tif"))

tic()
tpi500 = tpi(elevNA, scale = 500, win = "circle")

writeRaster(tpi500, datadir("prelim-outputs/topography/tpi_1.tif"), overwrite = TRUE)
toc()
```
